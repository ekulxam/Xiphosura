...
public class HorseshoeCrabModel<T extends HorseshoeCrabEntity> extends SinglePartEntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
        ...
        top_gills.render(matrices, vertexConsumer, light, overlay, color);
        left_gills.render(matrices, vertexConsumer, light, overlay, color);
        right_gills.render(matrices, vertexConsumer, light, overlay, color);
